package com.idohoo.user.protocol.resq;

import com.idohoo.user.protocol.Responsable;
import com.idohoo.user.protocol.UserMicroServiceProperty;

import java.util.Date;

public class UserMsResq implements UserMicroServiceProperty, Responsable {
    /**
